      ...
      <main className="bg-white py-20" id="procedure">
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl shadow-glow-md p-8 sm:p-10 lg:p-12">
            <ul className="list-disc text-muted leading-relaxed max-w-none text-justify prose prose-sm sm:prose-base pl-5">
              <li>
                The Placement Season begins in the month of August and goes up till May of the following year - From Aug ‘25 to May ‘26.
              </li>
              <br />

              <li>
                Invitations with relevant information and JNF are sent out to organizations by the Placement Office. Recruiters can connect with us directly via the mail{' '}
                <a href="mailto:placement@ietlucknow.ac.in" className="text-brand-700 underline">(placement@ietlucknow.ac.in)</a>.
              </li>
              <br />

              <li>
                Post intimation by a company, a list of interested candidates satisfying the company&apos;s criteria is prepared.
              </li>
              <br />

              <li>
                Tentative date for the company’s visit is worked out. After confirmation, the office arranges all the necessities for the Pre-Placement Talk and various rounds.
              </li>
              <br />

              <li>
                The company conducts its selection and shortlists students for the interview. The results are usually announced on the same day.
              </li>
              <br />

              <li>
                Students who receive confirmation letters are reserved for the company and not allowed to sit for any other visiting company of the same pay scale bracket (Student Policy). 
                Also once into the selection process, no student can drop out in the intermediate stage.
              </li>
            </ul>
          </div>
      ...
      <footer className="bg-brand-900 text-white pt-16 pb-8">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="border-t border-brand-800 pt-8 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div><a href="#procedure" className="text-sm underline hover:no-underline whitespace-nowrap">Go to Top</a></div>
          </div>
        </div>
      </footer>
    </div>
