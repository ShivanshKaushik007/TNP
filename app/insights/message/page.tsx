      ...
      <main className="bg-white py-16" id="message">
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-10">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-brand-800">
              Training and Placement Officer Incharge
            </h1>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
              ...
              <div className="lg:col-span-2 flex flex-col">
                <div className="prose prose-sm sm:prose-base max-w-none text-justify text-muted leading-relaxed">
                  <p>
                    On behalf of Institute of Engineering and Technology, Lucknow,
                    it is my pleasure to invite you to our beautiful academic
                    campus to conduct campus selection programme for our students.
                    Established in the year 1984, the institute has improved in
                    every domain in the last three decades. The students of this
                    institute are occupying enviable positions in various
                    organizations at home and abroad. Our students have lived up
                    to the expectations of organizations that visit the campus,
                    looking for bright candidates to take up important and
                    challenging responsibilities at their workplace. The Institute
                    has earned fame not only for its excellent academic and
                    extracurricular activities but also for its research,
                    consultancy and development activities. I am furnishing in the
                    pages to follow all pertinent information about our college
                    and students studying here. I would request you to kindly
                    visit our campus for selecting candidates of your choice on
                    any date convenient to both of us. Here at IET we look forward
                    to nurture and extend our relationship in upcoming years. We
                    truly appreciate the faith bestowed upon us by your
                    organization and we look forward to continuing our
                    relationship with you. Looking forward to meeting you at our
                    campus!
                  </p>
                </div>
              </div>
      ...
      <footer className="bg-brand-900 text-white pt-16 pb-8">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="border-t border-brand-800 pt-8 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div><a href="#message" className="text-sm underline hover:no-underline whitespace-nowrap">Go to Top</a></div>
          </div>
        </div>
      </footer>
    </div>
